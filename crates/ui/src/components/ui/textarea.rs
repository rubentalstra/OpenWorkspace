...
/// Styled multi-line text field. Every native `<textarea>` attribute, event and
/// binding is forwarded to the underlying element — set `attr:placeholder`,
/// `attr:rows`, `bind:value`, `on:input`, etc. at the call site.
#[component]
pub fn Textarea(
